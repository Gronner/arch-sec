...
Participants know the security properties of the universal triade: confidentiality, integrity and
availability. In additon they know additional common properties such as authentication, authorization
and non-repudiation.
